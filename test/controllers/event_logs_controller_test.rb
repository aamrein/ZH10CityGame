...
class EventLogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create event_log" do
    assert_difference('EventLog.count') do
      post event_logs_url, params: { event_log: { comment: @event_log.comment, event_id: @event_log.event_id, start: @event_log.start } }
    end
  ...
  test "should update event_log" do
    patch event_log_url(@event_log), params: { event_log: { comment: @event_log.comment, event_id: @event_log.event_id, start: @event_log.start } }
